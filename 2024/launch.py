import argparse, subprocess, sys, pathlib, difflib, shlex, os
...
os.system(r"g++ main.cpp -O3 -o main.exe")
# input_f = open("tests/01.in", "r")
# output_f = open("tests/01.out", "r")
# args = input_f.read().split("\n")
# process = subprocess.Popen(["main.exe", *args], stdout=subprocess.PIPE)
# output = process.stdout.read()
# expected_output = open("output.txt", "r").read().split("\n")

def main():
    ap = argparse.ArgumentParser()
    ap.add_argument("--exe", default="./main.exe")
